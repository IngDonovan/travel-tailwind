...
function App() {
  ...
  return (
    <>
      ...
      <aside id="tab_bar" className='h-16 w-full flex justify-center items-center gap-10 fixed bottom-0 bg-white opacity-95 shadow-custom'>
