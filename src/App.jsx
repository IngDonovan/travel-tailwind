...
function App() {
  ...
  return (
    <>
      ...
      <nav className='lg:flex items-center justify-between lg:p-6 bg-white text-primary text-lg font-bold hidden'>
          ...
          <ul className='flex gap-6'>
            ...
            <li>
              <span>
                <svg className='w-8 h-8 text-primary' viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className=" w-full h-full">
          ...
          <div className="absolute top-0 p-6 w-full h-full flex flex-col gap-5 self-center lg:gap-11">
            <span className="self-end bg-white px-4 py-2 rounded-3xl lg:hidden">
