    ...
    return (
        ...
        <nav className=' hidden lg:flex items-center justify-between lg:p-6 text-primary text-lg font-bold dark:text-white'>
            ...
            <ul className='flex gap-6'>
              ...
              <li>
                <span id='darkButtonDesktop' className='cursor-pointer'>
                  <svg className='w-8 h-8 text-gray-300 hover:text-primary' viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className=" w-full h-full lg:flex lg:w-auto lg:h-auto relative">
          <picture className="w-full h-full flex lg:h-[600px] lg:bg-sanFranciscoDesktop lg:bg-cover lg:bg-center">
          ...
          <div className="absolute top-0 p-6 w-full h-full flex flex-col gap-5 self-center lg:gap-11">
            <span className="self-end bg-white px-4 py-2 rounded-3xl cursor-pointer lg:hidden" id='darkButton'>
